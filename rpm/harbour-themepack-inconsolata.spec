Name:          harbour-themepack-inconsolata
Version:       0.0.1
Release:       3
Summary:       Inconsolata theme pack
Group:         System/Tools
Vendor:        fravaccaro
Distribution:  SailfishOS
Requires:      harbour-themepacksupport >= 0.8.8-1
Packager:      fravaccaro
URL:           https://github.com/uithemer/harbour-themepack-inconsolata
License:       GPLv3
Source0:       %{name}-%{version}.tar.gz
BuildArch:     noarch

%description
Inconsolata font package for Theme pack support for Sailfish OS.
